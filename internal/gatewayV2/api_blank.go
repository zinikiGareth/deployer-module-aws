...
type ApiBlank struct{}

func (b *ApiBlank) Mint(tools *corebottom.Tools, loc *errorsink.Location, id corebottom.CoinId, named string, props map[driverbottom.Identifier]driverbottom.Expr, teardown corebottom.TearDown) corebottom.Ensurable {
...
func (b *ApiBlank) ShortDescription() string {
	return "aws.ApiGatewayV2.Api[]"
}

var _ corebottom.Blank = &ApiBlank{}
